...
export default function Login() {
  ...
  const [isRegister, setIsRegister] = useState(false); // 切换登录与注册状态
  ...
  return (
    <div className="min-h-[80-screen] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
      <motion.div 
