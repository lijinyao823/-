        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/" className="text-sm text-gray-500 hover:text-wut-blue transition-colors">精选作品</Link></li>
              <li><Link to="/profile" className="text-sm text-gray-500 hover:text-wut-blue transition-colors">摄影师风采</Link></li>
